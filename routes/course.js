...
const { createCourse, addCourses, getCourses, getCourseById, getCoursesByCategory,updateCourse, deleteCourse , getCoursesByInstructor} = require('../controllers/courseController');
