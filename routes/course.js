...
const { createCourse, addCourses, getCourses, getCourseById, getCoursesByCategory,updateCourse, deleteCourse , getCoursesByInstructor,getCoursesFromDifferentCategories} = require('../controllers/courseController');
